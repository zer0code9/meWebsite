...
export default function ProjectCard({ title, description, logo, source }) {
    return (
        <projectcard className="relative flex flex-row items-center justify-around projectCard">
            <section className="pcardSection">
                <Image src={ logo } alt="" width={ 60 } height={ 60 }/>
            </section>
            <section className="flex flex-col pcardSection">
